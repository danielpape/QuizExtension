...
function generateLaws() {
	...
	document.getElementById('Answercard2').innerHTML = '<h3 class="overview">' + options[1].overview + '</h3><a id="Answercard2-learnMoreLink" href="' + options[1].link + '" class="Answercard-learnMoreLink displayNone">Learn More<svg class="openIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg></a>';
	document.getElementById('Answercard3').innerHTML = '<h3 class="overview">' + options[2].overview + '</h3><a id="Answercard3-learnMoreLink" href="' + options[2].link + '" class="Answercard-learnMoreLink displayNone">Learn More<svg class="openIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg></a>';
